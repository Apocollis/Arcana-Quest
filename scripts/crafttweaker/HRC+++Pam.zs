...
// Gin.add("custom:cotton", [<ore:cropCotton>], [<rustichromia:cotton_wool>], [<harvestcraft:cottonseeditem>], 3, 5000, 300);
...
// Quern.add("pams:bean_flour", [<ore:cropBean>], [<harvestcraft:flouritem>*2], 0, 5000,300);

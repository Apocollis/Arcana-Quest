...
filler.addItemEntry(<minecraft:paper>, 15, 0, [Functions.setCount(2, 4)], []);
...
goodies.addItemEntry(<minecraft:emerald>, 45, 0, [Functions.setCount(1, 3)], []);
...
treasure.addItemEntry(<minecraft:filled_map>, 8, 0, [Functions.parse({"function": "quark:set_treasure"})], []);
...
treasure.addItemEntry(<bountifulbaubles:trinketballoon>, 3, 0);

...
treasure.addItemEntry(<bountifulbaubles:trinketobsidianskull>, 2, 0);
// treasure.addItemEntry(<artifacts:snorkel>, 2, 0); // Removed: Snorkel does not exist in Bountiful Baubles or RLArtifacts

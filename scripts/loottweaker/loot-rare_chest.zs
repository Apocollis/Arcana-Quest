...
rare.addItemEntry(<bountifulbaubles:trinketballoon>, 1, 0);
rare.addItemEntry(<bountifulbaubles:trinketobsidianskull>, 1, 0);
...
rare.addItemEntry(<bountifulbaubles:trinketluckyhorseshoe>, 1, 0);
rare.addItemEntry(<bountifulbaubles:shieldcobalt>, 1, 0);
...
rare.addItemEntry(<bountifulbaubles:trinketmagiclenses>, 1, 0);